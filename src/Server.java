...
public class Server {
    public static void main(String[] args) throws IOException {
        ...
        try {
            URL imageUrl = new URL("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQyHL0zMHXLZLiZt1bjgPwGIo-wiAj2j_zpQ&s");
            ImageIcon backgroundImage = new ImageIcon(imageUrl);
            Image img = backgroundImage.getImage();  // Get the image
            Image resizedImage = img.getScaledInstance(frame.getWidth(), frame.getHeight(), Image.SCALE_SMOOTH);
        ...
        sendButton.addActionListener(e -> {
            ...
            pw.println(msg);  // Send message to client
        ...
        do {
            msg = br.readLine();
            addChatBubble(chatPanel, "Client: " + msg, false);  // Add incoming message to chat area
